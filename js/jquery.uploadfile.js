...
(function ($) {
    if ($.fn.ajaxForm == undefined) {
        ...
        $.getScript("http://"+ host +"/appstv/js/jquery.form.js");    
     }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<p style=\"color: green; text-align: center;\"><b><br/>Drag &amp; Drop Files to Upload</b></p>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
        ...
        $(uploadLabel).addClass( "btn btn-success btn-transparent text-center" );
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="ajax-upload-dragdrop" style="vertical-align:top; border: 1px dashed grey; padding: 0px;"></div>');
                    $(obj).before(dragDrop);
